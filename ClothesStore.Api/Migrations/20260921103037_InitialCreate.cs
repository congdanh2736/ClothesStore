    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionTechs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanceledOrders = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCollections_CollectionTechs_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "CollectionTechs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreDailyStats_StoreId_StatDate",
                table: "StoreDailyStats",
                columns: new[] { "StoreId", "StatDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StoreItemStats_StoreId_VariantId_StatDate",
                table: "StoreItemStats",
                columns: new[] { "StoreId", "VariantId", "StatDate" },
                unique: true);
